...
compile_cmd_common = 'clang -emit-llvm -O3 --target=wasm32 -nostdinc -nostdlib -nostdlibinc -ffreestanding -nostdlib -fno-threadsafe-statics -fno-rtti -fno-exceptions'
...
print('Assembling ......')
assemble_cmd = 'llc -thread-model=single --asm-verbose=false -march=wasm32' + ' -o ' + assembly_file + ' ' + linked_bc_file
